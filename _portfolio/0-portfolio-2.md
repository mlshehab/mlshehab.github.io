...
We are also working on an unsignalized intersection scenario generated using [Scenic](http://scenic-lang.org/). By encoding a first-come-first-serve logic using scenic, we can generate training scenarios where background vehicles also comply with the priorty rules at the intersection. Below is a video of our current setup.
